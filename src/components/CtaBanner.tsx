  ...
  return (
    <section className="py-6 flex justify-center mt-10">
      <div className="relative bg-gradient-to-r from-slate-800 via-blue-900 to-indigo-900 text-white overflow-hidden rounded-2xl max-w-7xl w-full mx-4 mb-10">
        ...
        {/* Floating Elements */}
        <div className="absolute top-4 left-8 w-12 h-12 bg-gradient-to-br from-blue-400/20 to-indigo-400/20 rounded-full blur-lg animate-pulse"></div>
        <div className="absolute bottom-4 right-8 w-16 h-16 bg-gradient-to-br from-indigo-400/20 to-purple-400/20 rounded-full blur-lg animate-pulse delay-1000"></div>
