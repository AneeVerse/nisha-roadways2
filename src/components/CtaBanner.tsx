...
{/* Trucks */}
          ...
          <div className="pointer-events-none select-none absolute inset-y-0 right-0 w-[22%] sm:w-[26%] md:w-[24%] lg:w-[26%] opacity-80 sm:opacity-90 md:opacity-100">
            <Image
...
{/* Content */}
          <div className="relative z-10 py-6 sm:py-8 md:py-12 lg:py-14 xl:py-16 min-h-[220px] grid place-items-center text-center px-3 sm:px-4 md:px-6">
            <h2 className="max-w-3xl text-[12px] sm:text-2xl md:text-3xl lg:text-4xl xl:text-4xl font-extrabold text-gray-900 leading-snug sm:leading-tight tracking-tight">
              Simplify your logistics with easy
              <br className="hidden sm:block" /> booking & real‑time tracking
            </h2>
            <p className="mt-2 sm:mt-3 md:mt-4 max-w-[200px] sm:max-w-2xl text-gray-600 text-[8px] sm:text-sm md:text-base px-1 sm:px-2 leading-relaxed">
