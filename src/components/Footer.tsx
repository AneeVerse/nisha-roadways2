            ...
            <div className="mb-12">
                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-2 gap-8 lg:gap-20">
                    ...
                    <div className="space-y-3">
                      ...
                      <Link href="/services/over-dimension-cargo" className="group relative text-white hover:text-blue-300 transition-all duration-300 text-sm py-3 px-4 border-l-3 border-white hover:border-blue-300 hover:bg-blue-900/20 rounded-r-lg block transform hover:translate-x-2 hover:shadow-lg hover:shadow-blue-500/20">
                    ...
                    <div className="space-y-3 ">
                      ...
                      <Link href="/services/high-value-goods" className="group relative text-white hover:text-blue-300 transition-all duration-300 text-sm py-3 px-4 border-l-3 border-white hover:border-blue-300 hover:bg-blue-900/20 rounded-r-lg block transform hover:translate-x-2 hover:shadow-lg hover:shadow-blue-500/20">
                        <span className="relative z-10">High Value Goods</span>
                        <div className="absolute inset-0 bg-gradient-to-r from-blue-600/0 to-blue-600/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-r-lg"></div>
                      </Link>
                      <Link href="/services/storage-warehousing" className="group relative text-white hover:text-blue-300 transition-all duration-300 text-sm py-3 px-4 border-l-3 border-white hover:border-blue-300 hover:bg-blue-900/20 rounded-r-lg block transform hover:translate-x-2 hover:shadow-lg hover:shadow-blue-500/20">
                        <span className="relative z-10">Storage & Warehousing</span>
                        <div className="absolute inset-0 bg-gradient-to-r from-blue-600/0 to-blue-600/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-r-lg"></div>
                      </Link>
                      <Link href="/services/lcl-consolidation" className="group relative text-white hover:text-blue-300 transition-all duration-300 text-sm py-3 px-4 border-l-3 border-white hover:border-blue-300 hover:bg-blue-900/20 rounded-r-lg block transform hover:translate-x-2 hover:shadow-lg hover:shadow-blue-500/20">
              ...
              <div className="flex justify-center mt-12">
                <div className="flex space-x-6">
                  ...
                  {/* WhatsApp/Phone */}
                  <a href="https://wa.me/919820420924" target="_blank" rel="noopener noreferrer" className="text-white hover:text-green-400 transition-colors duration-200 p-2 hover:bg-gray-800 rounded-full">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  {/* Email */}
                  <a href="mailto:info@nisharoadways.com" className="text-white hover:text-yellow-400 transition-colors duration-200 p-2 hover:bg-gray-800 rounded-full">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
