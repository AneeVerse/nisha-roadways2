  ...
  return (
    <footer ref={sectionRef} className="relative bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 text-white mt-8 overflow-hidden">
      ...
      <div className="relative h-24 overflow-visible mb-4 z-20" style={{ paddingTop: '20px' }}>
        ...
        <div
          ref={leftTruckRef}
          className="pointer-events-none absolute left-[-80px] top-[20%] z-50 flex items-center"
        >
          <Image
        ...
        <div
          ref={rightTruckRef}
          className="pointer-events-none absolute right-[-80px] top-[0%] z-40 flex items-center"
        >
          <Image
