          ...
          <div className="max-w-[1400px] mx-auto px-3 sm:px-6">
            ...
            <div className="mb-6 sm:mb-12">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr_1fr] gap-4 sm:gap-8 lg:gap-16">
                ...
                <div className="space-y-3 sm:space-y-6">
                  <div className="grid grid-cols-2 gap-4 sm:gap-8 lg:gap-20">
                    ...
                    <div className="space-y-1 sm:space-y-3">
                      ...
                      <Link href="/services/over-dimension-cargo" className="group relative text-white hover:text-blue-300 transition-all duration-300 text-[9px] sm:text-sm py-2 sm:py-3 px-2 sm:px-4 border-l-2 sm:border-l-3 border-white hover:border-blue-300 hover:bg-blue-900/20 rounded-r-lg block transform hover:translate-x-2">
                    ...
                    {/* Services Column 2 */}
                    <div className="space-y-1 sm:space-y-3">
                      <Link href="/services/bulk-cargo-solutions" className="group relative text-white hover:text-blue-300 transition-all duration-300 text-[9px] sm:text-sm py-2 sm:py-3 px-2 sm:px-4 border-l-2 sm:border-l-3 border-white hover:border-blue-300 hover:bg-blue-900/20 rounded-r-lg block transform hover:translate-x-2">
                        <span className="relative z-10">Bulk Cargo Solutions</span>
                      </Link>
                      <Link href="/services/high-value-goods" className="group relative text-white hover:text-blue-300 transition-all duration-300 text-[9px] sm:text-sm py-2 sm:py-3 px-2 sm:px-4 border-l-2 sm:border-l-3 border-white hover:border-blue-300 hover:bg-blue-900/20 rounded-r-lg block transform hover:translate-x-2">
                        <span className="relative z-10">High Value Goods</span>
                      </Link>
                      <Link href="/services/storage-warehousing" className="group relative text-white hover:text-blue-300 transition-all duration-300 text-[9px] sm:text-sm py-2 sm:py-3 px-2 sm:px-4 border-l-2 sm:border-l-3 border-white hover:border-blue-300 hover:bg-blue-900/20 rounded-r-lg block transform hover:translate-x-2">
                        <span className="relative z-10">Storage & Warehousing</span>
                      </Link>
                      <Link href="/services/lcl-consolidation" className="group relative text-white hover:text-blue-300 transition-all duration-300 text-[9px] sm:text-sm py-2 sm:py-3 px-2 sm:px-4 border-l-2 sm:border-l-3 border-white hover:border-blue-300 hover:bg-blue-900/20 rounded-r-lg block transform hover:translate-x-2">
                ...
                <div className="space-y-3 sm:space-y-6">
                  <div className="grid grid-cols-2 gap-4 sm:gap-6 lg:gap-30">
                    {/* Why Us Column */}
                    <div className="space-y-1 sm:space-y-3">
                      <Link href="/about" className="group relative text-white hover:text-blue-300 transition-all duration-300 text-[9px] sm:text-sm py-2 sm:py-3 px-2 sm:px-4 border-l-2 sm:border-l-3 border-white hover:border-blue-300 hover:bg-blue-900/20 rounded-r-lg block transform hover:translate-x-2">
                        <span className="relative z-10">About</span>
                      </Link>
                      <Link href="/team" className="group relative text-white hover:text-blue-300 transition-all duration-300 text-[9px] sm:text-sm py-2 sm:py-3 px-2 sm:px-4 border-l-2 sm:border-l-3 border-white hover:border-blue-300 hover:bg-blue-900/20 rounded-r-lg block transform hover:translate-x-2">
                        <span className="relative z-10">Team</span>
                      </Link>
                      <Link href="/partners" className="group relative text-white hover:text-blue-300 transition-all duration-300 text-[9px] sm:text-sm py-2 sm:py-3 px-2 sm:px-4 border-l-2 sm:border-l-3 border-white hover:border-blue-300 hover:bg-blue-900/20 rounded-r-lg block transform hover:translate-x-2">
                        <span className="relative z-10">Partners</span>
                      </Link>
                      <Link href="/testimonials" className="group relative text-white hover:text-blue-300 transition-all duration-300 text-[9px] sm:text-sm py-2 sm:py-3 px-2 sm:px-4 border-l-2 sm:border-l-3 border-white hover:border-blue-300 hover:bg-blue-900/20 rounded-r-lg block transform hover:translate-x-2">
                    ...
                    {/* Resources Column */}
                    <div className="space-y-1 sm:space-y-3">
                      <Link href="/blog" className="group relative text-white hover:text-blue-300 transition-all duration-300 text-[9px] sm:text-sm py-2 sm:py-3 px-2 sm:px-4 border-l-2 sm:border-l-3 border-white hover:border-blue-300 hover:bg-blue-900/20 rounded-r-lg block transform hover:translate-x-2">
                        <span className="relative z-10">Blog</span>
                      </Link>
                      <Link href="/academy" className="group relative text-white hover:text-blue-300 transition-all duration-300 text-[9px] sm:text-sm py-2 sm:py-3 px-2 sm:px-4 border-l-2 sm:border-l-3 border-white hover:border-blue-300 hover:bg-blue-900/20 rounded-r-lg block transform hover:translate-x-2">
                        <span className="relative z-10">Academy</span>
                      </Link>
                      <Link href="/faq" className="group relative text-white hover:text-blue-300 transition-all duration-300 text-[9px] sm:text-sm py-2 sm:py-3 px-2 sm:px-4 border-l-2 sm:border-l-3 border-white hover:border-blue-300 hover:bg-blue-900/20 rounded-r-lg block transform hover:translate-x-2">
