      ...
      <div className="px-2 sm:px-3 md:px-4 lg:px-6 xl:px-8 max-w-7xl mx-auto">
        ...
        <div className="block sm:hidden">
          <div className="columns-2 gap-3 space-y-3">
            ...
            <div className="rounded-xl bg-white/95 backdrop-blur-sm text-black p-6 break-inside-avoid mb-3 shadow-xl hover:shadow-2xl transition-all duration-300 flex items-center justify-center border border-white/20" style={{ minHeight: '160px' }}>
              <a
              ...
              >
                <div className="relative">
                  <Image 
                    ...
                    width={100}
                    height={100}
                    className="rounded-lg shadow-md border-2 border-blue-500"
                    loading="lazy"
                  />
