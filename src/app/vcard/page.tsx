...
export default function VCardPage() {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-purple-800 relative overflow-hidden">
      ...
      {/* Fixed Geometric Background Elements - Responsive positioning */}
      <div className="fixed inset-0 z-0">
        <div className="absolute top-0 left-0 w-full h-full">
          <div className="absolute top-10 sm:top-20 left-5 sm:left-10 w-16 sm:w-32 h-16 sm:h-32 border-2 border-pink-500 opacity-30 rotate-45"></div>
          <div className="absolute bottom-10 sm:bottom-20 right-5 sm:right-10 w-12 sm:w-24 h-12 sm:h-24 border-2 border-cyan-400 opacity-30 rotate-12"></div>
          <div className="absolute top-1/2 left-2 sm:left-5 w-8 sm:w-16 h-8 sm:h-16 border-2 border-purple-400 opacity-40 rotate-45"></div>
          <div className="absolute top-1/3 right-2 sm:right-5 w-10 sm:w-20 h-10 sm:h-20 border-2 border-blue-400 opacity-30 rotate-12"></div>
        </div>
      </div>
          ...
          <div className="relative w-full aspect-[1/1] sm:aspect-[1/1] rounded-xl sm:rounded-2xl overflow-hidden shadow-2xl transform transition-all duration-500">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-black/40 via-transparent to-black/60">
              <div className="flex flex-col justify-between h-full p-3 sm:p-6">
                ...
                {/* Contact Icons - Mobile responsive sizing and spacing */}
                <div className="flex justify-center space-x-4 sm:space-x-6">
                  <button 
                    onClick={handleWhatsAppClick}
                    className="w-10 sm:w-12 h-10 sm:h-12 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-white/30 transition-colors cursor-pointer"
                  >
